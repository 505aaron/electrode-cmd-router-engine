# Electrode CMS Router Engine

Handle async data for React Server Side Rendering using [react-router], Redux, and the [Redux Server Rendering] pattern. Routes are provided by a CMS service.

## Install

```bash
$ npm install -save electrode-cms-router-engine
```
